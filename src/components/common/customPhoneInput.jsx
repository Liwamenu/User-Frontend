    ...
    <div className={`flex flex-col w-full relative ${className2}`}>
      ...
      <PhoneInput
        ...
        inputProps={{
          ...
          className: `px-4 py-2.5 text-base font-[300] rounded-md border border-solid border-[--border-1] text-[--black-1] max-md:pr-5 w-full autofill:shadow-white autofill:outline-none ${className}`,
        }}
      />
    </div>
  );
