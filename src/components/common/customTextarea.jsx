  ...
  return (
    <div className={`flex flex-col w-full relative ${className2}`}>
      ...
      <textarea
        ...
        className={`px-4 pt-2 h-20 text-base font-[300] rounded-md sm:rounded-md border border-solid border-[--border-1] text-[--gr-1] max-md:pr-5 w-full autofill:shadow-[--white-1] autofill:outline-none ${className}`}
      />
      <div
